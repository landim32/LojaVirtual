...
<div class="container">
    <div class="row">
            ...
            <?php if ($eAdmin == true) : ?>
                <div class="row">
                    <div class="col-md-12 text-right">
                        <a href="<?php echo $app->getBaseUrl() . "/usuario/listar"; ?>" class="btn btn-lg btn-default">
        ...
        <div class="col-md-3" style="padding-top: 40px;">
            ...
            <a class="confirm" href="<?php echo $app->getBaseUrl() . "/usuario/" . $usuario->getSlug() . "/excluir"; ?>"><i class="fa fa-fw fa-trash"></i> Excluir</a>
            <?php endif; ?>
        </div>
    </div>
</div>

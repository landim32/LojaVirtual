...
$formClasse = ($fonteGrande == true) ? "form-group form-group-lg" : "form-group";
$inputClasse = ($fonteGrande == true) ? "input-group input-group-lg" : "input-group";
        ...
        <div class="col-md-6">
            ...
            <div class="row" style="margin-bottom: 15px">
                <div class="col-md-6">
                    ...
                    <div class="<?php echo $inputClasse; ?>">
